		...
		<div className="w-full h-22 light-bg rounded-xl shadow-2xl flex flex-col mt-4">
			<div className="w-full flex flex-row justify-between py-2 px-4">
				<div className="flex items-center justify-center">
					<input type="checkbox" onChange={() => {setChecked(!checked); console.log("Checked?: ", checked)}} className="w-6 h-6 form-tick appearance-none rounded-full cursor-pointer checked:bg-cyan border-2 border-cyan checked:light-bg checked:border-transparent focus:outline-none" />
				</div>
				<div className="w-full flex flex-row justify-between py-2 px-4">
